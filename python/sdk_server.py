...
try:
    ...
    print(f"ERROR: claude-agent-sdk not installed or incomplete. Run: pip install claude-agent-sdk\nDetails: {e}", file=sys.stderr)
    sys.exit(1)
...
async def initialize(req: InitializeRequest):
    try:
        ...
        session_state.model = req.model or os.environ.get("ANTHROPIC_MODEL", "claude-sonnet-4-5-20250929")
                ...
                async with ClaudeSDKClient(options) as client:
                    ...
                    async for message in client.receive_response():
                        ...
                        if msg_type == 'ResultMessage':
                            ...
                            print(f"Emitted ResultMessage: cost=${result_data.get('total_cost_usd', 0):.4f}", file=sys.stderr)
                        ...
                        if hasattr(message, 'content'):
                            for block in message.content:
                                ...
                                if block_type == 'ThinkingBlock':
                                    ...
                                    print(f"Emitted ThinkingBlock: {len(thinking_data['thinking'])} chars", file=sys.stderr)
                                    ...
                                    print(f"Emitted ToolUseBlock: {tool_use_data['name']}", file=sys.stderr)
